...
# There is no corpus to fetch and no shared fixture directory to
# populate: this repository ships neither (see AGENTS.md, "Error
# codes"). Parity is held against rs/tests/oracle/ebnf-ir.json, which IS
# committed, so the suite needs nothing from the network.
